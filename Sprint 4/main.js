...
var myT = new controlobject(canvas,241,30,500,620);
objectSet.push(myT);
//SHAPE BUTTONS
//(text, x, y,w, h, stroke, fill, textC,over,canvas)
var ShapeOne = new ShapeButton("rectangle",20, 30, 200,50, colArray[1][2], colArray[2][2], colArray[0][3],colArray[0][0], canvas);
var ShapeTwo = new ShapeButton("ellipse",20, 100, 200,50, colArray[1][2], colArray[2][2], colArray[0][3],colArray[0][0],canvas);

var ShapeThree = new ShapeButton("circle",20, 170, 200,50, colArray[1][2], colArray[2][2], colArray[0][3],colArray[0][0],canvas);

objectSet.push(ShapeOne,ShapeTwo,ShapeThree);
