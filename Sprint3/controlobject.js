...
class controlobject {
    constructor(canvas, x,y,w,h){
        ...
        draw(){
            ...
            //this.drawEllipse(this.xMouseStart, this.yMouseStart, this.xMouse, this.yMouse);
        ...
        drawRect(x,y,w,h){
            ...
            ctx.rect(x,y,w,h);
            ctx.lineWidth = 2;
            ctx.strokeStyle = Swatch.selectedColour; //determines the colour of the stroke of the dragging rectangle 
            ctx.stroke();
        }
