    ...
    constructor(canvas, x,y,w,h){
        ...
        if(this.mouseDown == true && this.rectBound == true){
            ...
            if(Button.selectedShape == "rectangle"){
                ...
                var EOne = new Ellipse(this.xMouseStart, this.yMouseStart, this.xMouse, this.yMouse, colArray[2][3]);
        ...
        /*drawEllipse(xC, yC, radiusX, radiusY, rotation, 
            startAngle, endAngle){
            ctx.beginPath();
            ctx.ellipse(xC, yC,radiusX,radiusY, rotation, 
                startAngle,endAngle);
